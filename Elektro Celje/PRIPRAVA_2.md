...
## 1. ELEKTROENERGETSKA INFRASTRUKTURA – OSNOVE
...
- Znati moraš: filtrirati po protokolu (ip.addr, tcp.port), slediti TCP toku, identificirati anomalije
...
## 7. VARNOST PRI DELU (relevantno za razgovor!)

### Laserska varnost
- Optična vlakna oddajajo **lasersko sevanje razredov 1 ali 1M** (pod normalnima pogoji nenevarna)
- Aktivnih vlaken **nikoli ne gleda direktno** v oko ali z optičnim povečalom
- Pred delom: preveri ali so vlakna aktivna (z laserskim indikatorjem/OTDR, ne z očesom!)
- Čisti konektorji: IPA alkohol ali specialni čistilci, nikoli s prsti
- **Usposabljanje**: obvezno po predpisih (zakonska zahteva)

### Delo na višini (antenske postaje)
- Antene so na stolpih in strehah – obvezna **usposobljenost za delo na višini**
- Oprema: varovalni pas, blokada pada, čelada
- Pred delom: pregled opreme, vremenska ocena, delovni nalog
- **Cone nevarne za RF sevanje**: pred oddajnimi antenami ne stajaš v aktivnem stanju sistema
...
- **SNMP traps vs. polling**: trapi so asinhroni alarmi; polling je periodično spraševanje

---

## 9. PROJEKTNO VODENJE (osnove)

### Metodologije
- **Waterfall**: faze si sledijo (zahteve → načrt → izvedba → testiranje → uvajanje)
- **Agile/Scrum**: iterativni pristop, sprinti; manj tipičen za infrastrukturne projekte
- Energetska podjetja večinoma sledijo **tradicionalnemu vodenju projektov**

### Okviri
- **PRINCE2** – popularen v EU energetiki
- **PMI/PMBOK** – ameriški standard, PMP certifikat
- **Faze projekta**: iniciacija, planiranje, izvedba, monitoring & kontrola, zaključek

### Kar od tebe pričakujejo (praktično)
- Pripravljati **terminskih planov** (Gantt diagram: MS Project, Excel)
- Koordinirati zunanja izvajalca
- Pisati **poročila o stanju** in **zaključna poročila**
- Upravljati **tveganja in spremembe**
